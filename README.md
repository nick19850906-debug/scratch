...
## 1. 프로젝트 개요
터미널 CLI, Docker 컨테이너, Git/GitHub 환경을 손수 구축하고 검증하여, "내 컴퓨터에서만 돌아가는" 문제를 방지하고 팀원 누구나 재현 가능한 **표준 개발자 워크스테이션(Development Workstation)**을 완하는 프로젝트입니다.
