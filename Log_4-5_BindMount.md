...
c1134czi5625@c5r4s7 ~ % docker run -d -p 8081:80 --name bind-mount-test -v $(pwd)/app:/usr/share/nginx/html nginx:alpine
f9e8d7c6b5a4...

# 8081 포트 응답 확인
c1134czi5625@c5r4s7 ~ % curl http://localhost:8081 | grep "h1"
...
c1134czi5625@c5r4s7 ~ % sed -i '' 's/Codyssey Mission 1 커스텀 웹 서버 성공/바인드 마운트 실시간 변경 검증 성공/g' app/index.html
