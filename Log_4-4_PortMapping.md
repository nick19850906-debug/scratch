...
c1134czi5625@c5r4s7 ~ % docker run -d -p 8080:80 --name web-port-test my-custom-web:1.0
a1b2c3d4e5f6...

# 구동 상태 및 포트 매핑 확인
c1134czi5625@c5r4s7 ~ % docker ps | grep web-port-test
...
```bash
c1134czi5625@c5r4s7 ~ % curl -i http://localhost:8080
HTTP/1.1 200 OK
Server: nginx/1.25.4
